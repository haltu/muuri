(function (window) {
  ...
  QUnit.test('dragReceive: should be triggered when item is dragged to another grid', function (assert) {
    ...
    gridB.on('dragReceive', function (ev, data) {
      ...
      assert.strictEqual(data.fromGrid, gridA, 'callback: second argument fromGrid property should be the sending grid instance');
